...
[![Build Status](https://travis-ci.org/dentech-floss/jsonapi.svg?branch=master)](https://travis-ci.org/dentech-floss/jsonapi)
[![Go Report Card](https://goreportcard.com/badge/github.com/dentech-floss/jsonapi)](https://goreportcard.com/report/github.com/dentech-floss/jsonapi)
[![GoDoc](https://godoc.org/github.com/dentech-floss/jsonapi?status.svg)](http://godoc.org/github.com/dentech-floss/jsonapi)
...
```
go get -u github.com/dentech-floss/jsonapi
```
...
[examples/app.go](https://github.com/dentech-floss/jsonapi/blob/master/examples/app.go)
...
* `go get github.com/dentech-floss/jsonapi`.  (Append `-u` after `get` if you
  are updating.)
* `cd $GOPATH/src/github.com/dentech-floss/jsonapi/examples`
* `go build && ./examples`
...
[jsonapi.UnmarshalPayload](http://godoc.org/github.com/dentech-floss/jsonapi#UnmarshalPayload).
...
[MarshalOnePayload](http://godoc.org/github.com/dentech-floss/jsonapi#MarshalOnePayload),
...
Visit [godoc](http://godoc.org/github.com/dentech-floss/jsonapi#UnmarshalPayload)
...
Visit [godoc](http://godoc.org/github.com/dentech-floss/jsonapi#MarshalPayload)
...
Visit [godoc](http://godoc.org/github.com/dentech-floss/jsonapi#UnmarshalManyPayload)
...
Visit [godoc](http://godoc.org/github.com/dentech-floss/jsonapi#MarshalOnePayloadEmbedded)
...
```
git subtree add --squash --prefix=src/github.com/dentech-floss/jsonapi https://github.com/dentech-floss/jsonapi.git master
```

To update,

```
git subtree pull --squash --prefix=src/github.com/dentech-floss/jsonapi https://github.com/dentech-floss/jsonapi.git master
```
